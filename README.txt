...
Compile ld_preload library code
...
- Based on: http://www.catonmat.net/blog/simple-ld-preload-tutorial/
- See also:
...
Compile shared library with:
  $ gcc -Wall -fPIC -shared -ldl -o test_ld_preload-fopen.so \
        test_ld_preload-fopen.c
...
and run test with initialise, finalise and overloaded functions:
